...
var Tests = []Test{
	...
	{
		exp:    `$ceil(.arrayFloat[0])`,
		result: `2`,
	},
	{
		exp:    `$coalesce($ceil(0.0), 1)`,
		result: `1`,
	},
	{
	...
	{
		exp:    `$all(.arrayBoolAll)`,
		result: `true`,
	},
	{
		exp:    `$all(.arrayBoolAny)`,
		result: `false`,
	},
	{
		exp:    `$any(.arrayBoolAny)`,
		result: `true`,
	},
	{
		exp:    `$any(.arrayBoolAll)`,
		result: `true`,
	},
	{
		exp:    `$regex(.p_version, "1\.021\...")`,
		result: `true`,
	},
	{
		exp:    `$regex(.n_version, "1\.021\.\d\d")`,
		result: `false`,
	},
	{
		exp:    `$has(.haskey, "GB")`,
	...
	{
		exp:    `$chance(.check_chance, 0.4)`,
		result: `true`,
	},
	{
		exp:    `$chance(.check_chance_1, 0.4)`,
		result: `false`,
	},
	{
		exp:    `$bucket(.check_chance_1, 1, 0)`,
		result: `true`,
	},
	{
		exp:    `$bucket(.check_chance, 2, 1)`,
		result: `true`,
	},
	{
		exp:    `$bucket(.check_chance, 10, 2)`,
		result: `true`,
	},
}
